    ...
    <header className="sticky top-0 z-50 w-full border-b border-border/50 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
      <div className="container flex h-16 items-center">
        <div className="mr-6 flex items-center space-x-2">
          ...
          <span className="hidden font-bold sm:inline-block font-jokerman text-lg text-primary drop-shadow-[0_0_8px_rgba(255,255,255,0.7)]">
            McDelta SMP
          </span>
        </div>
            ...
            <SheetContent side="right">
              <nav className="grid gap-6 text-lg font-medium pt-10">
                <div className="flex items-center gap-2 text-lg font-semibold mb-4">
                  ...
                  <span className="font-jokerman text-primary drop-shadow-[0_0_8px_rgba(255,255,255,0.7)]">McDelta SMP</span>
                </div>
