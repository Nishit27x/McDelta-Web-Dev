    ...
    <header className="sticky top-0 z-50 w-full border-b border-border/50 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
      <div className="container flex h-16 items-center">
        <div className="mr-6 flex items-center space-x-2">
          ...
          <span className="font-bold sm:inline-block font-jokerman text-lg text-white drop-shadow-[0_0_8px_rgba(255,255,255,0.7)]">
            McDelta SMP
          </span>
        </div>
        <nav className="hidden md:flex items-center space-x-6 text-sm font-medium">
          ...
          <Link href="/credits" className="text-muted-foreground transition-colors hover:text-foreground" suppressHydrationWarning>Credits</Link>
          ...
          <Sheet>
            ...
            <SheetContent side="right">
              ...
              <nav className="grid gap-6 text-lg font-medium pt-10">
                ...
                <Link href="/credits" className="text-muted-foreground hover:text-foreground" suppressHydrationWarning>Credits</Link>
